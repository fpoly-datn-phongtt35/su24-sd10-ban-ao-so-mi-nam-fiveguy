app.controller('nguyen-bill-detail-ctrl', function ($scope, $http, $rootScope, $routeParams, $timeout, $location, $window) {
    ...
    $scope.reasonsList = {
        ...
        6: { text: "Không liên hệ được nhân viên giao hàng", value: 6, status: 0, shortenText: "Không LH nv giao" },
        ...
        9: { text: "Không liên hệ được khách", value: 9, status: 2, shortenText: "Không liên hệ KH" },
        10: { text: "Khách hẹn giao lại", value: 10, status: 3, shortenText: "Hẹn giao lại" },
        11: { text: "Mất hàng", value: 11, status: 4, shortenText: "Mất hàng" },
        12: { text: "Thiếu hàng", value: 12, status: 5, shortenText: "Thiếu hàng" },
