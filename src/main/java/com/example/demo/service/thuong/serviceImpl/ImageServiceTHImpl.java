...
import com.example.demo.advice.FileNotFoundException;
import com.example.demo.advice.StorageException;
import com.example.demo.advice.StorageProperties;
...
public class ImageServiceTHImpl implements ImageServiceTH {
    ...
    @Autowired
    public ImageServiceTHImpl(StorageProperties properties) {
