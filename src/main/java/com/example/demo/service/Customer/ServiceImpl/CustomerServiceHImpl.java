...
public class CustomerServiceHImpl implements CustomerServiceH {
    ...
    //get all Customer status = 1 (dang làm)
    @Override
    ...
    @Override
    public Page<Customer> findCustomer(String fullName, String code, String avatar, Date birthDate, Boolean gender, String account, String email, String phoneNumber, String name, Integer status, Pageable pageable) {
...
////                .and(CustomerSpecificationH.hasCustomerType(name))
...
//            return null;
    ...
    //delete theo status
    @Override
    public  Customer updateStatus(Long id, Customer customers){
