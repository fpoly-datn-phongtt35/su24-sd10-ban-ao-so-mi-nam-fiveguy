...
public class CustomerSpecificationH {
    ...
    public static Specification<Customer> hasCustomerType(Long id) {
        return (root, query, criteriaBuilder) -> {
            if (id == null) {
                return criteriaBuilder.conjunction();
            }
            return criteriaBuilder.equal(root.get("customerType").get("id"), id);
        };
    }
